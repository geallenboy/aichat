...
export const enableClerk = 'NEXT_PUBLIC_ENABLE_CLERK_AUTH';
export const enableNextAuth = 'NEXT_PUBLIC_ENABLE_NEXT_AUTH';
export const enableAuth = 'NEXT_PUBLIC_ENABLE_CLERK_AUTH'
